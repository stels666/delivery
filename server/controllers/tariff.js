...
module.exports = function(app) {
    app.get('/private/tariff/get/:id', _processGetTariff);
    app.post('/private/tariff/create', _processCreateTariff);
    app.post('/public/tariff/calculate', _processCalculateTariff);
};
